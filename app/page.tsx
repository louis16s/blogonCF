...
export default async function Home() {
  ...
  return (
    <>
      ...
      <BlogExplorer initialPosts={payload?.posts} initialLinks={payload?.links} initialNotice={payload?.notice} initialConfig={payload?.config} initialNotionConfigured={payload?.notionConfigured} />
    </>
  );
}
